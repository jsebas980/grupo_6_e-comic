CREATE DATABASE IF NOT EXISTS `eComic_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `eComic_db`;
...
DROP TABLE IF EXISTS `rol_personas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `productos_personas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `productos_personas` (
  `id` int NOT NULL AUTO_INCREMENT,
